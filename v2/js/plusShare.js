(function() {
    ...
    function share(id, msg, callback,err_callback) {
...
//              callback && callback(false);
                err_callback && err_callback(false);
            })
        }
    };
    ...
    var open = function(msg, callback,err_callback) {
            ...
            plus.nativeUI.actionSheet({
                ...
                switch (index) {
                    case 1: //分享到微信好友
                        ...
                        share('weixin', msg, callback,err_callback);
                        break;
                    case 2: //分享到微信朋友圈
