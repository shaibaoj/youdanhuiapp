...
(function($, owner) {
	...
	owner.set_txt = function(page_id){
		if(page_id=='index'){
			...
			document.querySelector("#footer_kuaibao_txt").innerHTML = '优惠线报';
			...
			document.querySelector("#search-key").placeholder = '我的';
			
			document.querySelector("#btn-check-in").classList.add("icon-qiandao");
			
			document.querySelector("#footer_home_icon").classList.add("icon-jingxuan");
			document.querySelector("#footer_kuaibao_icon").classList.add("icon-youhui");
			document.querySelector("#foot_search_icon").classList.add("icon-youhuiquan");
			document.querySelector("#foot_99_icon").classList.add("icon-jiubaoyou");
			document.querySelector("#foot_member_icon").classList.add("icon-wode-on");
		}
			...
			document.querySelector("#my_soucang_txt").innerHTML = '收藏';
			document.querySelector("#my_yaoqing_txt").innerHTML = '邀请奖励';
			document.querySelector("#my_hehuoren_txt").innerHTML = '合伙人';
			document.querySelector("#my_gouwuche_txt").innerHTML = '淘宝购物车';
			
			document.querySelector("#my_xiaoxi_icon").classList.add("icon-xiaoxi");
			document.querySelector("#my_shezhi_icon").classList.add("icon-iconshezhi01");
			
			document.querySelector("#my_order_icon").classList.add("icon-wodedingdan");
			document.querySelector("#my_shaidan_icon").classList.add("icon-shaidan");			
			document.querySelector("#my_jifenduihuan_icon").classList.add("icon-jifenduihuan");		
			document.querySelector("#my_soucang_icon").classList.add("icon-mxsoucangxuanzhong");		
			document.querySelector("#my_yaoqing_icon").classList.add("icon-yaoqing");		
			document.querySelector("#my_hehuoren_icon").classList.add("icon-hehuoren");		
			document.querySelector("#my_gouwuche_icon").classList.add("icon-gouwucheman");
